...
Статус: план будущего обучения, окружение не создано, расходы не запущены, модель не обучена.
...
4. Передать исходные CSV в `data/raw/` разрешённым способом; сверить SHA-256 с manifest. Большие данные и ключи не коммитить.
5. Установить зависимости из будущего lockfile и ecCodes; сохранить версии Python, LightGBM и декодера GRIB.
