...
export default function App() {
  ...
  return <main className="page"><header className="topbar"><div className="brand"><span className="mark">W</span><div><strong>Wind Operator</strong><span>Forecast replay console</span></div></div><div className={`statuses ${error ? 'has-error' : ''}`}><span><i />Backend {source === 'demo' ? 'fixture' : stateLabel}</span><span><i />Agent {source === 'demo' ? 'fixture' : stateLabel}</span>{source === 'demo' && <b>DEMO DATA · NOT LIVE</b>}</div></header>
