...
export const copy = {
  en: {
    ...
    agentActivity: 'Pipeline & AI activity', toolsUsed: 'Worker and AI decision events for this run', complete: 'Complete', done: 'Done', warning: 'Warning', runDetails: 'Run details', detailsSubtitle: 'Inputs, validation, and revision history', warnings: 'Warnings', revisionHistory: 'Revision history', parent: 'Parent', firstRevision: 'First revision', noActiveRun: 'No active run', sampleRun: 'Sample run',
  ...
  kk: {
    ...
    agentActivity: 'Pipeline және AI белсенділігі', toolsUsed: 'Осы іске қосудың worker және AI шешім оқиғалары', complete: 'Аяқталды', done: 'Дайын', warning: 'Ескерту', runDetails: 'Іске қосу мәліметтері', detailsSubtitle: 'Кірістер, тексерулер және нұсқалар тарихы', warnings: 'Ескертулер', revisionHistory: 'Нұсқалар тарихы', parent: 'Алдыңғы нұсқа', firstRevision: 'Бірінші нұсқа', noActiveRun: 'Белсенді іске қосу жоқ', sampleRun: 'Үлгі іске қосу',
