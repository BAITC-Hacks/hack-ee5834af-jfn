...
The separate archived-GFS training and validation pipeline is documented in [`docs/gfs-training.md`](../docs/gfs-training.md). Its sparse January holdout favors the GFS power-curve baseline over the new GFS LightGBM. These models were trained locally on CPU in this change, not on Brev.
