    ...
    def compute_run(self, run_id: str, worker_attempt: int | None = None) -> str:
        ...
        try:
            ...
            audit.update({"model_training_cutoff":metadata["training_cutoff"],
                          ...
                          "model_feature_schema":metadata.get("feature_order"),
                          "model_source_timezone":metadata.get("source_timezone"),
                          "model_source_weather_provider":metadata.get("source_weather_provider"),
